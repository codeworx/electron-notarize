...
function startNotarize(opts) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return yield helpers_1.withTempDir((dir) => __awaiter(this, void 0, void 0, function* () {
            ...
            d('zip succeeded');
            if ((_a = opts.lifecycle) === null || _a === void 0 ? void 0 : _a.beforeUpload) {
                d('awaiting beforeUpload lifecycle hook');
                yield ((_b = opts.lifecycle) === null || _b === void 0 ? void 0 : _b.beforeUpload());
            }
            ...
            if ((_c = opts.lifecycle) === null || _c === void 0 ? void 0 : _c.afterUpload) {
                d('awaiting afterUpload lifecycle hook');
                yield ((_d = opts.lifecycle) === null || _d === void 0 ? void 0 : _d.afterUpload());
            }
            return {
                uuid: uuidMatch[1],
            };
